...
const SkillDirectory = ({ skill }) => {
    ...
    return (
        <div className="flex gap-5 items-center border-white ml-5 w-full overflow-hidden">
            <div className="flex-0 h-full bg-[#ff9040] w-[200px] shadow-[2px_2px_5px_2px_rgba(0,0,0,0.5)] rounded-3xl flex flex-col items-center justify-center text-center">
                <div className="">
