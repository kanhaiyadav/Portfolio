...
const SkillDirectory = ({ skill }) => {
    ...
    return (
        <div className="flex flex-0 h gap-5 items-center border-white w-full overflow-hidden">
            <div className="flex-0 h-[160px] bg-[#642d19] w-[130px] md:w-[200px] shadow-[2px_2px_5px_2px_rgba(0,0,0,0.5)] rounded-3xl flex flex-col items-center justify-center text-center">
                <div className="">
            ...
            <div className="flex-1 shadow-[inset_0_0_15px_5px_rgba(0,0,0,0.8)] bg-black hide-x-scrollbar hide-x-scrollbar overflow-scroll p-5 rounded-[15px]">
