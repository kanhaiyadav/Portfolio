        ...
        <>
            ...
            <div className="flex-1 overflow-auto flex flex-col items-center gap-5 p-4">
                <div className="flex items-center gap-5">
                    <h1 className="text-3xl font-Playwrite1 md:text-4xl text-[#c54d20]">{title}</h1>
                ...
                <div className="skill-directory pt-4 pb-10 flex justify-center items-center flex-wrap gap-8 w-[420px] sm:w-[600px] md:w-[750px] lg:w-[1000px] h-[500px] md:h-[430px] overflow-auto">
                    {
