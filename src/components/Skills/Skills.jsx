...
const Skills = () => {
    return (
        <section id="skills" className="overflow-x-hidden min-w-screen bg-no-repeat bg-[url('/src/assets/layered-waves-haikei.svg')] bg-cover flex flex-col gap-10 items-start justify-center h-screen bg-position">
