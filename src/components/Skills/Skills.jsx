...
const Skills = () => {
    return (
        <section id="skills" className="overflow-x-hidden w-screen bg-no-repeat bg-[url('/src/assets/layered-waves-haikei.svg')] bg-cover flex flex-col gap-10 items-start justify-center min-h-screen bg-position p-10 pt-20">
