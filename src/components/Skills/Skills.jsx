...
const Skills = () => {
    return (
        <section id="skills" className="relative overflow-hidden h-screen w-screen bg-no-repeat flex flex-col items-center gap-10 justify-center  pr-10 pl-10 pb-4 pt-4"
            style={{
