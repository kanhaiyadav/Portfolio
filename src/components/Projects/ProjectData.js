export const web = {
    ...
    projects: [
        {
            path: '/src/assets/todoApp.png',
            imgPath: '/src/assets/icon.png',
            title: 'YourCheckMate',
...
export const python = {
    ...
    projects: [
        ...
        {
            path: '/src/assets/calculator.png',
            imgPath: '/src/assets/python.png',
            title: 'Calculator',
