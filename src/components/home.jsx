...
const Home = () => {
    return (
        <section id="home" className="relative overflow-x-hidden min-w-screen bg-no-repeat bg-[url('/layered-steps-haikei.svg')] bg-center bg-fixed min-h-screen bg-cover flex flex-row items-center justify-center  p-2xl">
            ...
            >
                <div className='text-center'>
                    ...
                    <h1 className='m-4 animate-bounce font-Rowdies text-white' style={{fontSize: 'clamp(50px, 4.7vw, 100px)'}}>Kanhaiya <br /> Yadav</h1>
                    <div className='inline-block'>
                        <P className={'animate-typewriter2 w-0 text-[#c54d20] font-bold text-xl'}>I am a Passionate</P>
                    </div>
                    <br />
                    <div className='inline-block'>
                        <P className={'animate-typewriter3 w-0 text-[#c54d20] font-bold'}
                            style={{
                ...
                <div className='drop-shadow-2xl animate-imgBounce group object-cover overflow-hidden box-content rounded-sm shadow-[10px_10px_0px_2px_rgba(0,0,0,1)]'
                    style={{
