const Nav = () => {
    return (
        <nav className="z-50 fixed translate-x-[-50%] left-2/4  py-3 px-1.5 rounded-2xl bg-[#d3b714] my-8 outline outline-offset-8 outline-4 outline-[#e73635]">
            <ul className="list-none flex flex-row gap-5 text-white text-xl">
                <li>
                    <a href="#" className="text-white px-3 py-1.5 rounded-xl bg-[#e73635]">Home</a>
                </li>
                <li>
